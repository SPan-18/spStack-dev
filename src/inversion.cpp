...
void inversionLM2(double *X, int n, int p, double deltasq, double *VbetaInv,
  ...
  double *tmp_n1 = (double *) R_alloc(n, sizeof(double)); zeros2(tmp_n1, n);
  double *tmp_n2 = (double *) R_alloc(n, sizeof(double)); zeros2(tmp_n2, n);

  double *tmp_np1 = (double *) R_alloc(np, sizeof(double)); zeros2(tmp_np1, np);
  double *tmp_np2 = (double *) R_alloc(np, sizeof(double)); zeros2(tmp_np2, np);

  double *tmp_p1 = (double *) R_alloc(p, sizeof(double)); zeros2(tmp_p1, p);

  double *tmp_pp = (double *) R_alloc(pp, sizeof(double)); zeros2(tmp_pp, pp);
