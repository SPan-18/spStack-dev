...
#' @export
spLMexact2 <- function(formula, data = parent.frame(), coords, cor.fn, priors, spParams, noise_sp_ratio, n.samples, verbose = TRUE, ...) {
    ...
    out <- .Call("spLMexact2", y, X, p, n, coords.D, beta.prior, beta.Norm, sigma.sq.IG, phi, nu, deltasq, cor.fn, n.samples, verbose)
