#' Synthetic data from a spatial linear model
#'
#' @description Dataset of size 500, simulated from a spatial linear model with
#'  spatial coordinates sampled uniformly on a unit square, one covariate and
#'  spatial correlation induced by a Matérn covariogram.
#' @format a \code{data.frame} object.
#' \describe{
#'  \item{`s1, s2`}{2-D coordinates; latitude and longitude.}
#'  \item{`x1`}{a covariate sampled from a standard normal.}
#'  \item{`y`}{response vector.}
#'  \item{`z_true`}{true spatial random effects that generated the data.}
#' }
#' @usage data(simLMdat)
#' @details The data is generated from the following linear model.
#' \deqn{
#' y = X \beta + z + \epsilon,
#' }
