...
#'
#' @param formula a symbolic description of the regression model to be fit. See
#' example below.
...
#' covariance model key words are: \code{'exponential'} and \code{'matern'}. See
#' below for details.
...
#' @export
spLMexact <- function(formula, data = parent.frame(), coords, cor.fn, priors, spParams, noise_sp_ratio, n.samples, verbose = TRUE, ...) {
